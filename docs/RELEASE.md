...
Refract supports two update channels:
...
# - Tag: v2.0.8-beta.1
# - Title: Refract v2.0.8-beta.1
# - Mark as "Pre-release"
# - Upload files from release/:
#   - Refract Setup 2.0.8-beta.1.exe
#   - Refract.2.0.8-beta.1.exe
...
# 3. Upload to GitHub Release
# - Tag: v2.0.8
# - Title: Refract v2.0.8
# - Upload files from release/:
#   - Refract Setup 2.0.8.exe
#   - Refract.2.0.8.exe
