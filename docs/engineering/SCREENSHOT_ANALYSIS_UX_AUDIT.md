...
**Commit:** `43ae233d7148`
**Surface inspected:** `src/components/RefractInterface.tsx`,
...
`RefractInterface.tsx:3101-3104` renders a `Monitor`-icon pill with four states:
...
`RefractInterface.tsx:3111-3143` shows a Screen Recording warning banner
...
- `RefractInterface.tsx:3185` calls
...
- The chip wording "OCR attached" / "OCR unavailable" assumes the user
  knows what OCR is. Refract uses "Reading your screen" / "Couldn't read
  screen" — friendlier.
...
- The screenshot preview in the attachment area
  (`RefractInterface.tsx:3311-3329`) does communicate "yes, the AI will
