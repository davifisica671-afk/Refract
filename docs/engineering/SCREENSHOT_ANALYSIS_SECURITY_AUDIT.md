...
[
  '/Users/evin/Library/Application Support/Refract/screenshots/abc.png',
  '/Users/evin/Library/Application Support/Refract/extra_screenshots/sel.png',
...
`/Users/<user>/Library/Application Support/Refract`, which always starts with
...
- **Bypass:** `LLMHelper.streamChat → streamChatWithGemini` calls
  `streamWithRefract`, `streamWithCodexCli`, `streamWithOpenaiMultimodal`,
...
- For Refract API uploads, images are downscaled with Sharp to ≤768 px on
...
| 7 | P2 | No image-size cap before sending to Claude/OpenAI/Gemini | Reuse the Sharp resize already used for Refract for every cloud path |
