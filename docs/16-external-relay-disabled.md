...
STT_RELAY_US_URL=wss://us-relay.refract.software/v1/transcribe
STT_RELAY_ASIA_URL=wss://asia-relay.refract.software/v1/transcribe
...
**Verify it's back on:**
```
curl https://api.refract.software/v1/stt/relays -H "Authorization: Bearer $KEY"
