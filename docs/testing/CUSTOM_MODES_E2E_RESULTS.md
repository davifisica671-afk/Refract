...
| 2 | Why beat Refract | `investor_competitor_landscape.xml` (Refract lacks per-mode reference files) | PASS |
...
| 2 | Comparison to Refract | `demo_feature_matrix.csv` (per_mode_reference_files YES/NO/NO/NO) | PASS |
