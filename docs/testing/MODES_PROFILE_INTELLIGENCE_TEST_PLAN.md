...
Version: 1.0  
Owner: Refract QA automation  
Last updated: 2026-05-15

## 1. Mission

Refract's reported-bug fix cycle does not verify whether each mode behaves like a real product. This plan establishes a deep, **realistic, end-to-end** test system for:
...
9. Refract API integration (when configured)
...
1. Behavioral interview — resume includes PriceX & Refract (sentinel: "candidate built PriceX, a price-comparison website, and scaled Refract to 10k users").
...
| 9 | Real Refract API integration (env-gated) | Skipped unless env set |
