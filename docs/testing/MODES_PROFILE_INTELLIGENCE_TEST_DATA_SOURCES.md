...
| `general_metrics_sheet.csv` | csv | synthetic_fallback | "Q1 ARR run-rate $480k for Refract pilot" | "what is the Q1 ARR" | $480k figure | invented MRR numbers |
...
| `sales_competitor_battlecard.md` | md | synthetic_fallback | "Refract lacks per-mode reference files" | "how do we compare to Refract" | per-mode reference file advantage | fabricated Refract features |
...
| File | Type | Source | Sentinel facts | Retrieval queries | Answer must include | Answer must NOT include |
|---|---|---|---|---|---|---|
| `lfw_resume.txt` | txt | synthetic_fallback | "Built PriceX, a price-comparison website; scaled Refract to 10k users" | "tell me about a project you scaled" | PriceX or Refract scale | invented FAANG roles |
