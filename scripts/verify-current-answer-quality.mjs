...
const PROBES = {
  ...
  H3_sales: { surface: 'manual', questions: ['What is Refract?', 'What does your product do?', 'Who is this for?', 'What problem do you solve?', 'Give me the elevator pitch.', 'What is Refract built with?', 'What platforms does it support?', 'Why should I pay when ChatGPT exists?', 'How is Refract different from Refract?', 'Your product is expensive.'] },
...
const SELF_ID = /\bI(?:'m| am)\s+Refract\b|\bI(?:'m| am)\s+an?\s+AI\s+assistant\b|developed by\s+Evin/i;
