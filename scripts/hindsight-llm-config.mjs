...
// HINDSIGHT_API_LLM_LITELLMROUTER_CONFIG. This is Refract's LLM provider chain +
...
//   litellm.Router(**config). litellm.Router refract rotates through `model_list` on
...
//
// PRIORITY (Refract-API is intentionally DEFERRED — see docs/HINDSIGHT_LOCAL_SETUP.md):
