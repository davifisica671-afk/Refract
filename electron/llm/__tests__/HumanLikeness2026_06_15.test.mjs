...
//
// Fase 12 (tarefa 2026-06-15, bug #8): grounded answers lê como corporate/LinkedIn
// boilerplate. O human-likeness proteger adiciona a prompt directive para spoken candidate/sales
// answers and a deterministic corporate-filler detector — applied Apenas to those types,
// nunca to code/lecture/diagram/technical/search.
...
describe('detectCorporateFiller — flags boilerplate, passes real speech', () => {
  ...
  test('matched phrases are generic boilerplate (safe to log — no profile content)', () => {
    ...
    // Todo match é a generic phrase, não a name/company/number.
