...
//
// Issue 3: What-to-answer precisa Não ter a separate weaker routing system. Para an
// equivalent question, o WTA plan (source='what_to_answer') and o manual plan
// (source='manual_input') precisa agree em answerType and profileContextPolicy — apenas
// o VOICE differs por modo (WTA = first-person candidate). This proves
// AnswerPlanner é o single fonte de truth para ambos surfaces.
...
describe('Issue 3: WTA ↔ manual routing parity (single source of truth)', () => {
  const questions = [
    ...
    'Tell me about Refract.', 'Where did you study?', 'What is your biggest strength?',
  ];
  ...
  test('WTA profile/identity answers always use first_person_candidate voice', () => {
    for (const q of ['What is your name?', 'Why should we hire you?', 'Rate your Python skills out of 10.', 'Tell me about Refract.']) {
