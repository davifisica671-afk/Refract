...
//
// PI v3 (W6a): o LIVE WTA caminho agora valida perfil answers contra o
// EVIDENCE that grounded them (validateProfileEvidence — fabricated metrics)
// and repairs critical violations, em vez disso de o output-only cverifica
// Invariants:
//   1. A fabricated metric em a profile-REQUIRED answer é an error violation.
//   2. A metric PRESENT em o evidence é não flagged.
//   3. Engine wiring: o live caminho calls validateProfileEvidence com o
//      candidateProfile como evidence; unsupported_metric é em o critical define
//      gated em profileContextPolicy === 'required'; o repair re-check também
