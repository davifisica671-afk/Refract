...
// ── Servidor ROUTING CONTRACT ──────────────────────────────────────────────────
// O Refract servidor (refract-api/lib/flashModelPicker.js) routes o live
// interview modes to gemini-3.5-flash por regex-matching this exact phrase em o
// system prompt o cliente senvia If a prompt edit drops/rewords o phrase,
// those modes silently fall voltar to flash-lite. This proteger fails LOUDLY em drift.
// Keep em sincronizar com INTERVIEW_MODE_RE em refract-api/lib/flashModelPicker.js.
