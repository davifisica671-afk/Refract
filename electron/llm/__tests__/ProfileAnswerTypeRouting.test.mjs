...
//
// Spec §1-§4 + §8: o answer-type classifier precisa rotea cada question class to
// o direito answerType, and o per-type contexto layers precisa include/exclude o
// direito ccontexto Plain nó (pure planAnswer, não DB/LLM).
...
describe('Spec: answer-type classification', () => {
  const cases = [
    // identity (ambos my/your nome — §1, §11.1/2)
