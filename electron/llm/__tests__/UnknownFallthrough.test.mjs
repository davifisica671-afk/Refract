...
// Issue 8: unknown_answer fallthroughs precisa ser rare (<5 em o 300 dataset). Bare
// follow-up fragments rotea to a concrete candidate tipo quando they carry sinal
// (a named skill / work noun / voice-control directive — release 2026-06-06
// Issues 4/5/6/7); apenas Verdadeiramente context-free fragments ("o que sobre data?") stay em
// o follow_up floor. "confidence" → skill. Qualquer que seja o concrete ttipo Nenhum de
// these é já unknown_answer (o propriedade this suite guards).
...
describe('Issue 8: bare follow-ups and control directives are not unknown', () => {
  for (const [q, expected] of [
    // Pure-signal-less fragments stay em o follow_up floor (resolved live).
    ['Why?', 'follow_up_answer'], ['How so?', 'follow_up_answer'],
    ['What about data?', 'follow_up_answer'],
    // Signal-bearing fragments agora resolve to a concrete tipo até standalone
    // (release 2026-06-06): a named skill / work noun → skill_experience;
    // voice/evidence-control directives → a candidate answer por embedded cue.
