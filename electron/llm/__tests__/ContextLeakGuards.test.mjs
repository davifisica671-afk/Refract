...
//
// Issue 5: contexto leaks = 0. Profile/JD/negotiation contexto precisa nunca leak dentro de
// sales / meeting / lecture / coding / technical answers. O credibility-for-
// selling question precisa rotea to product_candidate_mix (não résumé dump), não
// profile_fact.
...
describe('Issue 5: meeting / lecture / sales forbid candidate profile', () => {
  const cases = [
    ...
    ['How do you compare with competitors?', null], // sales-ish, precisa forbid perfil
  ];
