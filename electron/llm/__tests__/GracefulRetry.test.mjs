...
//
// PI v3 (W6b): buildGracefulRetry substitui o single fixed "Poderia you repeat
// that?…" canned reply at o three live failure sites. Invariants:
//   1. Deterministic: mesmo question → mesmo osaída
//   2. Topic-aware: a claro question yields a tentar novamente that names o topic.
//   3. Safe: nunca echoes comp/salary topics, nunca dumps longo questions,
//      nunca fabricates an answer (it é sempre a retry/clarify line).
//   4. Variation: different questions pode land different templates.
//   5. Wired: o three IntelligenceEngine sites + o WTA catch uso it.
