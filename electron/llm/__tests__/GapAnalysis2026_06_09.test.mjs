...
//
// Release 2026-06-09 — gap/weakness-for-the-JD questions obtém a dedicated
// gap_analysis_answer (honest gap + mitigation, first-person candidate), Não o
// jd_fit fit-summary and Não a stall.
...
describe('gap answers stay in the right lane', () => {
  ...
  test('the gap contract instructs gap-first, not a fit-summary, no stall', () => {
    ...
    // o contract explicitly forbids o stall ("Fazer não say 'let me come back…voltar
