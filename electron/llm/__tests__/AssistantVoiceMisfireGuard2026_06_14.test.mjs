...
//
// Regression para o Groq-scout E2E sprint finding (2026-06-14): smaller models
// (llama-4-scout) over-apply o prompt's "if asked quem you arsão identity reply to
// scurto context-free meeting/sales/follow-up questions, emitting
// "I'm Refract, an AI assistant. I era developed por Evin John." ou o stock
// "I can't share that information." em vez disso de a real answer. Those answer types são
// ASSISTANT-voice, então they bypass sanitizeCandidateAnswer — detectAssistantVoiceMisfire
// catches o misfire então o caller substitutes an honest line.
...
describe('detectAssistantVoiceMisfire — identity misfire', () => {
  test('flags the canned identity reply', () => {
    const r = detectAssistantVoiceMisfire("I'm Refract, an AI assistant. I was developed by Evin John.");
...
describe('detectAssistantVoiceMisfire — does NOT over-trigger', () => {
  ...
  // code-review 2026-06-14 MEDIUM-1: o identity branch precisa Não match a legitimate
  // role description that merely inicia "I am an assistant…".
  ...
  // …mas o real canned misfires ainda fire após o anchor tightening.
