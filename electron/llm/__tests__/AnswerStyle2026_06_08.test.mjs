...
// de o question and shapes FORM apenas — nunca routing, voice, grounding, ou leak
// boundaries.
...
describe('detectAnswerStyle — normal questions stay default (no routing-affecting false positives)', () => {
  for (const q of ['what is your name', 'tell me about Refract', 'solve two sum', 'why should we hire you', 'rate your Python out of 10', 'what is eventual consistency']) {
