...
//
// Propriedade tests para checkCodeCompleteness (spoken-answer-quality sprint). Truncated code
// (unbalanced brackets, unclosed ffunção dangling ttoken unterminated sstring precisa ser
// flagged; VALID code — incluindo code com brackets dentro strings/comments — precisa Não ser
...
describe('checkCodeCompleteness — language-specific false-positive guards (code-review 2026-06-15)', () => {
  ...
  // Genuine truncation precisa Ainda ser caught em these mesmo languages.
