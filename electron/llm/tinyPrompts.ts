...
// Compact system prompts para small/local LLMs (4B-8B params, <=8K cocontexto
// Cada TINY_* é <=800 tokens (~3200 chars). Não XML, não nested rules, imperative voice.
// Cloud models continue para uso o completo prompts em prompts.ts.

import { CODING_CONTRACT_TINY } from "./codingContract";

export const TINY_CORE = `You are Refract, an AI assistant by Evin John. Follow the active mode prompt for voice and shape.
...
// First-person mandate para live interview / candidate-role modes oapenas
// Composed dentro de TINY_ANSWER, TINY_WHAT_TO_ANSWER, TINY_MODE_LOOKING_FOR_WORK,
// TINY_MODE_TECHNICAL_INTERVIEW, TINY_MODE_TEAM_MEET — Não dentro de o universal
// TINY_SYSTEM_PROMPT, recruiting (third-person obobservador ou lecture
...
// Compact human-voice regra para small/local models (o full-tier equivalent é
// HUMAN_SPOKEN_ANSWER_CONTRACT em prompts.ts). Style-only, não perfil facts.
// Composed dentro de o SPOKEN tiny prompts (answer / WTA / looking-for-work /
// technical-interview non-code / sales / follow-up) — Não recap / summary-json /
// code-hint código section / lecture notes.
// Compact spoken-LENGTH regra para pequeno models (full-tier equivalent: SPOKEN_ANSWER_CONTRACT).
...
// Conditional coding-format rregra An EXPLICIT user formata requisição beats o default
// six-heading DSA template (mirrors codingFollowup.detectExplicitCodingContract em o
// completo tier). Substitui o antigo unconditional "uso o exact coding headings" line então a
// pequeno modelo honors "code oapenas / "complexity oapenas / "dry executa oapenas / "explain onapenas
...
// Conjunto de todos tiny prompts que deve bypass modo injection em streamChat.
// Keep em sincronizar com o individual exporta aacima
