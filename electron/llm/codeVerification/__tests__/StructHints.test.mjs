...
//
// Python/JS linked-list & binary-tree verification via o spec's argTypes/
// retType hints (GAP 1 para dynamically-typed languages). Real execution, gated
// em python3/node. Também pins backward-compat: não hints → plain JSON values.
