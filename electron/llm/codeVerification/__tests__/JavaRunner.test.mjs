...
//
// Java verification (GAP 2). Driver GENERATION é pure and sempre tested. Real
// compile/run é gated em a local JDK (javac+java) and Pula quando absent — em
// CI/dev sem Java, o orchestrator precisa Pular (runtime_unavailable), nunca a
// false verdict. Quando a JDK é present o gated tests prove correct/wrong/skip.
