...
/**
 * Provedor de STT capaz de marcar locutores.
 *
 * Contrato: `setDiarization(true)` passa a emitir `speakerId` nos eventos de
 * transcrição. Ligar ou desligar pode reiniciar o stream, porque normalmente é
 * parâmetro de conexão — implementações devem tolerar a chamada a qualquer
 * momento.
 */
...
/** Type guard estrutural: verdadeiro se o provedor implementa a capacidade. */
