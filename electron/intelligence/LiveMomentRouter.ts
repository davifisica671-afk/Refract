...
//
// A único moment-level router para live answers. This é authoritative para o
// NEW surface area — o live_moment_action taxonomy, speakability talvo and
// marker-only telemetry — enquanto deliberately delegating o fine-grained
// AnswerType para o existing, benchmark-green planAnswer cascade então perfil
// grounding, voice, e leak boundaries stay byte-identical.
//
// Pure, deterministic, não I/O, não perfil strings.
...
export interface LiveMomentDecision {
  ...
  intentSignal?: string;
  /** Future seam para a verdadeiro answerType osobrescrever intentionally dark em v1. */
