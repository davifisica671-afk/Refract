// Fase 14 — Lecture Intelligence: structured notes, concepts, definitions,
// flashcards, exam questions, rrevisão course memory. Sample transcripts por prompt.
...
describe('LectureNoteGenerator — structured notes', () => {
  ...
  test('NO interview/sales contamination (lecture stays a learning artifact)', () => {
    ...
    assert.doesNotMatch(blob, /candidate|resume|hire|salary|objection|I am Refract/i);
  });
