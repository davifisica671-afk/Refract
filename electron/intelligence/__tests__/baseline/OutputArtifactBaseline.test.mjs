// Fase 2 BASELINE — saída artifacts + answer diversity characterization.
// Pins current behavior de o real answerPolish.ts (cleanAnswerArtifacts,
// AnswerDiversityGuard, compressToSpeakable) então Fase 5 pode harden sem regressing.
// Encodes o prompt's "específico bugs to prprevenir empty "*" bullets, repeated
...
describe('PHASE2 baseline — answer diversity guard', () => {
  test('flags a repeated opening sentence across DIFFERENT asks', () => {
    ...
    guard.record(`${opener} I shipped Refract.`, 'jd_fit_answer', 'why should we hire you?');
