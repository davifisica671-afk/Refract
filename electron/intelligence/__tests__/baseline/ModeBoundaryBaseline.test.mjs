// Fase 2 BASELINE — modo boundaries + latency budgets.
// Characterizes o current planAnswer routing então sales/lecture/coding pode nunca
// regress dentro de pulling candidate pperfil Encodes o prompt's mode-boundary rules.
...
describe('PHASE2 baseline — latency budget invariants', () => {
  ...
  test('a direct identity question is deterministic-fast-path eligible (no provider needed)', () => {
    ...
    // canUseFastPath signals o deterministic caminho pode answer sem o LLM.
