// Fase 2 BASELINE — pending systems (Não BUILT YEAinda
// O prompt exige real tests para existing systems and pending/skipped TODO tests
// para systems that don't exist yainda então o harness records o gap sem failing.
// These become real tests em their respective phases (10/11/12/13/14/15/16).
