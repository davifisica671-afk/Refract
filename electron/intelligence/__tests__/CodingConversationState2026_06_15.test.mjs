...
//
// Propriedade tests para CodingConversationState (spoken-answer-quality sprint). A multi-turn
// coding thread precisa keep o ORIGINAL problem sticky enquanto CURRENT advances, então
// complexity/dry-run/optimize follow-ups resolve to o current problem and "o que era o
// original problem?" resolves to o primeiro one. Não fixed answer strings; behavioural.
