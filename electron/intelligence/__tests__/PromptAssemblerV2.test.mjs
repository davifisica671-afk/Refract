// Fase 9 — Prompt Assembler V2: trust-tagged XML, inclusion report, contracts,
// candidate-perspective gproteger injection escaping.
...
describe('PromptAssemblerV2 — inclusion report (source tracing)', () => {
  test('reports included and dropped sources with reasons', () => {
    const contract = contractFrom(
      ...
      { mode: 'sales' }, // perfil suppressed em sales
    );
