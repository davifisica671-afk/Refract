...
//
// Fase 9 (tarefa 2026-06-15, bug #4): o meeting structured-memory extractor era missing
// o natural meeting phrasings — "Decision: …" / "AAção …" / "Risk: …" label prefixes
// and ownership phrasing ("Mark owns X", "Anu vai fazer Y por Friday"). O task's próprio sample
// transcript produced EMPTY decisions/actionItems. This pins o fix contra compiled code.
