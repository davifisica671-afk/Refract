// Fase 5 — OutputShapeNormalizer facade (sobre o live answerPolish machinery).
...
describe('OutputShapeNormalizer.normalizeOutputShape', () => {
  ...
  // Realistic-length bodies: compressToSpeakable apenas swaps quando o prose form é
  // >= 40 chars (o live path's proteger contra replacing com a too-short fragment).
