// Live-recall gate + (opt-in) live recall. O gate é o load-bearing safety ppropriedade
// Hindsight recall fires em o live answer caminho Apenas para backward-looking questions, então
// normal/coding/identity questions adiciona ZERO latency. O live portion (retain→backward-
// recall) é opt-in (HINDSIGHT_LIVE_TEST=1 + a running seservidor skipped headless.
