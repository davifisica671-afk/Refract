...
import { registerSettingsPassthroughHandlers } from './ipc/settingsPassthroughHandlers';
import { registerRepoIndexerHandlers } from './ipc/repoIndexerHandlers';
import { registerCodeAssistantHandlers } from './ipc/codeAssistantHandlers';
import { registerOpencodeHandlers } from './ipc/opencodeHandlers';
import { registerReplicaHandlers } from './ipc/replicaHandlers';
...
export function initializeIpcHandlers(appState: AppState): void {
  ...
  registerSettingsPassthroughHandlers(safeHandle);

  registerRepoIndexerHandlers(safeHandle);

  registerCodeAssistantHandlers(appState, safeHandle);

  registerOpencodeHandlers(safeHandle);

  registerReplicaHandlers(appState, safeHandle);

  registerGitHandlers(safeHandle);
