...
const SALES_TRIGGERS: ActionTrigger[] = [
    ...
    },
    {
        ...
        promptInstruction:
            "You are in Sales mode. The prospect mentioned a competitor. Position Refract's advantages confidently without disparaging the competitor.",
...
export class DynamicActionDetector {
    ...
    detectTriggers(params: {
        ...
        // Obtém aciona para isso mmodo alternativa para vazio array
        ...
        for (const trigger of modeTriggers) {
            for (const pattern of trigger.patterns) {
                ...
                if (match) {
                    ...
                    break; // Apenas uso primeiro matching pattern por acionar
                }
            }
        }
