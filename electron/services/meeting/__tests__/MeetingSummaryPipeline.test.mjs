...
test('sales call surfaces actionability, objections, risks, and follow-up', () => {
  ...
  // Follow-up draft é agora produced por FollowUpDraftGenerator (Fase 8), não o reducer.
  // O reducer's deterministic corpo builder precisa ainda surface o action/decision content.
