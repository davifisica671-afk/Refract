// CrossMeetingRecall.ts (Fase 13)
// Light, local-first cross-meeting intelligence. Given a freshly-generated MeetingSummaryV3
// e a lista de recente prior meeting summaries, surfaces:
//   - carriedOpenQuestions : abrir questions que também appeared em a recente meeting
//   - recurringRisks       : risks/blockers seen antes
//   - stillOpen            : curto "ainda abrir de último time" lines para o UI
//
// Pure + deterministic (word-overlap matching). Não LLM, não network. Degrades para vazio quando
// lá é não prior history. Hindsight é Não required.
...
// Extrair o comparable lite shape de a stored detailedSummary blob (V3 ou legacy).
