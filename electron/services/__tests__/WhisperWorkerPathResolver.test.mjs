// Tests executa contra o esbuild-compiled workerPathResolver em dist-electron/.
// Executa vvia npm executa build:electron && nó --testar electron/services/__tests__/
//
// O que this guards acontra a future refactor that drops one de o candidate
// paths de o resolver mas doesn't notice porque o unbundled-layout
// candidate ainda works em dev. esbuild ships dentro de o bundled layout, que
// é onde o original bug (#244) lived.
