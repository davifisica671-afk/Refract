...
test('redactForLog scrubs API keys, bearer tokens, JWTs, and refract/Anthropic key shapes', async () => {
  const { redactForLog } = await loadRedactor();

  const inputs = [
    'auth: Bearer abc123def456ghi789jkl0mn',
    'refract_sk_THIS_SHOULD_BE_HIDDEN',
