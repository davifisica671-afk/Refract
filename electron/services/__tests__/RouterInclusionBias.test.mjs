...
// Verifica o inclusion-bias routing em KnowledgeOrchestrator.processQuestion:
//   - clearly-generic questions → Completo bypass (null), clean factual answer
//   - candidate-directed questions → completo retrieval/assembly caminho
//   - ambiguous questions (GENERAL intent, não framing, não generic) → COMPACT
//     identity injected em contextBlock (inclusion bias), heavy retrieval skipped
//   - compact identity é dynamic (qualquer reretomar self-labeled, XML-safe
// Replicates o decision logic; faz não touch o DB ou LLM.
// RExecuta nó --testar electron/services/__tests__/RouterInclusionBias.test.mjs

import { test, describe } from 'node:test';
import assert from 'node:assert/strict';

// --- Mirror de o relevant predicates (kept em sincronizar com IntentClassifier) ---
...
// Minimal intent stand-in: candidate-directed intents o router treats specially
...
// --- Mirror de buildCompactIdentityBlock (production, dynamic de resume/JD) ---
...
// --- Mirror de o routing decision em processQuestion ---
...
describe('inclusion bias: ambiguous → compact identity (the fix)', () => {
  // Não generic, GENERAL intent, não candidate framing — o false-skip risk bucket.
