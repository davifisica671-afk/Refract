// Overlay clarify / follow-up contexto assembly — verifica interim interviewer
// partials são included então overlay actions see o mesmo rolling STT o UI smostra
