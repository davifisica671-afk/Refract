...
//
// Regression para FINDING-004: Premium ingest caminho (PDF/DOCX através
// KnowledgeOrchestrator.ingestDocument) é gated end-to-end mas tem não
// service-level testar that asserts a parsed retomar produces o direito
// <candidate_experience> blocks downstream.
//
// This testar uses o actual KnowledgeDatabaseManager (não a stub) então todos
// its methods são available sem qualquer method-shimming overhead.
...
// ---------------------------------------------------------------------------
// Fixture: realistic retomar text
// ---------------------------------------------------------------------------
...
describe('FINDING-004: KnowledgeOrchestrator ingest pipeline', () => {
    ...
    test('resume ingest produces correct identity, experience, and skill blocks via getProfileData()', async () => {
        ...
        // skills é agora a categorized objeto {languages,frameworks,cloud,...};
        // o derived flat lista é exposed como skillsFlat.
