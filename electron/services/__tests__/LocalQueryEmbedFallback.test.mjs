...
// Verifica resolveQueryEmbedder's dimension-checked fallback em
// KnowledgeOrchestrator: o fast on-device consulta embedder (MiniLM, ~10ms) é
// used Apenas quando its dimension matches o indexed nodes — caso contrário it falls
// voltar to o index-matching embedder, porque HybridSearchEngine.cosineSimilarity
// silently Retorna 0 através mismatched dimensions (semantic score → 0).
// Replicates resolveQueryEmbedder's decision logic eexatamente
// RExecuta nó --testar electron/services/__tests__/LocalQueryEmbedFallback.test.mjs

import { test, describe } from 'node:test';
import assert from 'node:assert/strict';

// Mirror de KnowledgeOrchestrator.resolveQueryEmbedder (kept em sysincronizar
