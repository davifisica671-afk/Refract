...
test('Duplicate action suppressed within window', async () => {
  ...
  // Segundo detection de mesmo pattern
...
test('expanded trigger packs cover canonical Refract-style phrases across modes', async () => {
  const { DynamicActionEngine } = await loadModules();
