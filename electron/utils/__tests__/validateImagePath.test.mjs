...
//
// Regression tests para o validateImagePath ordering fix (observation 2631).
//
// Em macOS, app.getPath('userData') resolves to a caminho como
//   /Users/<user>/Library/Application Support/<AppName>/
// O função Precisa permitir this prefix Antes o generic `/Users/` block,
// caso contrário todo legitimate screenshot caminho é rejected at o IPC layer.
//
// ScreenshotHelper escreve to <userData>/screenshots and <userData>/extra_screenshots,
// então this ordering é o que unblocks o screenshot → vision pipeline termina to etermina
...
const MAC_USER_DATA = '/Users/alice/Library/Application Support/Refract';
