...
impl SpeakerInput {
    pub fn new(device_id: Option<String>) -> Result<Self> {
        ...
        if !force_sck {
            // Tentar CoreAudio Tap primeiro (Default)
...
impl SpeakerStream {
    ...
    /// Pausar o underlying audio stream sem destroying it.
    ...
    /// Retomar o underlying audio sstream
    /// Retorna Err para CoreAudio (needs completo recreation); SCK é a no-op.
