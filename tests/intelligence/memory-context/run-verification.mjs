...
process.env.REFRACT_MEETING_MEMORY_V2 = 'true';
process.env.REFRACT_PROFILE_TREE_V2 = 'true';
process.env.REFRACT_GLOBAL_SEARCH_V2 = 'true';
process.env.REFRACT_IN_MEETING_SEARCH_V2 = 'true';
process.env.REFRACT_INTELLIGENCE_ATTRIBUTION = 'true';
...
function score(item, res) {
  ...
  if (e.noAssistantLeak && res.answer) ok('no_assistant_leak', !/I'?m Refract|I am Refract|an AI assistant/i.test(res.answer));
