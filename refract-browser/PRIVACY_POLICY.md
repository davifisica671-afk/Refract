# Privacy Policy for Refract Companion

*Last Updated: June 13, 2026*

Refract ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how the Refract Companion Chrome Extension handles user data.

---

## 1. Information Collection and Use

The Refract Companion Chrome Extension **does not collect, store, or transmit any personal data, tracking information, or browsing history** to Refract or any third-party servers.
...
- **Local Transmission Only:** The extracted content is sent directly to your locally running Refract desktop application via a secure local loopback connection (`http://127.0.0.1` and `ws://127.0.0.1`).
...
- **Host Permissions (`http://127.0.0.1/*`, `ws://127.0.0.1/*`):** Needed to send data to the Refract desktop application running on your computer.
