...
// Simulate o collapsed shell (600px) centered em o fixed 780px window:
// ~90px transparent margins cada side. Window-local coords aqui para clarity.
...
test('NaN / non-numeric coords → not over content (defensive)', () => {
  ...
  // @ts-expect-error intentional bad entrada
...
test('expanded shell (780 == window width) → margins vanish, full width is content', () => {
  // Quando expanded o panel fills o window; apenas top/bottom margins remain.
