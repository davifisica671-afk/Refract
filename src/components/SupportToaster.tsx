...
/**
 * SupportToaster.tsx
 * Notificação de suporte que aparece após alguns segundos na inicialização.
 * Incentiva o usuário a apoiar o desenvolvimento do Refract com doação.
 * Inclui animação de preenchimento líquido no ícone de coração.
 */
...
export const SupportToaster: React.FC<SupportToasterProps> = ({ className }) => {
    ...
    const handleSupport = () => {
        ...
        if (window.electronAPI?.openExternal) {
            window.electronAPI.openExternal('https://buymeacoffee.com/joaolucas');
        } else {
            window.open('https://buymeacoffee.com/joaolucas', '_blank');
        }
    };
                ...
                <div className={`fixed inset-0 z-[9999] flex items-center justify-center ${isLight ? 'bg-black/20 backdrop-blur-[4px]' : 'bg-black/60 backdrop-blur-[4px]'}`}>
                    ...
                    >
                        ...
                        <div style={{
                            ...
                            {/* Top cabeçalho com dismiss button */}
                            ...
                            <div className="relative z-10 w-full flex flex-col items-center pt-[32px]">
                                ...
                                <div className="relative mb-[24px] w-[32px] h-[32px]">
                                    ...
                                    {/* 1. O Liquid Container (Masked to Heart Shape) */}
                                    <div
                                    ...
                                    >
                                        ...
                                        >
                                            {/* Inner Wave Top - Sits at o top de o filling coluna */}
                                            <div
                                ...
                                <div className="text-center px-[40px] mb-[28px]">
                                    ...
                                    <p style={{ color: t3 }} className="text-[13.5px] leading-[1.6] max-w-[340px] mx-auto font-medium antialiased">
                                        Refract is built and maintained by one developer. If it's part of your daily workflow, your support keeps it moving forward.
                                    </p>
                                </div>
