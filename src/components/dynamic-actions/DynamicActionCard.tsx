 ...
 *
 * Cartão individual de ação dinâmica exibido na barra de ações ao vivo.
 * Compacto, com estilo vidro, descartável. O cartão primário (maior prioridade)
 * obtém destaque sutil e dica de atalho. Os cartões são intencionalmente
 * leves — clicar em aceitar dispara o callback do componente pai.
 */
...
// Single dynamic ação card. Compact, glass-styled, dismissible.
// Primário cartão (highest priority) obtém a subtle accent + shortcut hint.
// Cards são intentionally lightweight — clicking accept fires o parent
// retorno de chamada que é responsible para kicking fora o answer stream então o
// cartão si mesmo stays presentation-only.
