 ...
 *
 * Painel de gerenciamento de modelos Whisper locais para transcrição de fala.
 * Permite baixar, excluir e configurar modelos de IA para inferência STT
 * sem depender de serviços em nuvem. Suporta configuração de canais
 * de áudio separados (microfone e áudio do sistema).
 */
...
export function LocalWhisperModelPanel() {
    ...
    const loadData = useCallback(async () => {
        try {
            ...
            // Auto-select initial models se nenhum são define
