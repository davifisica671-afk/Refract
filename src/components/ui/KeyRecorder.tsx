/**
 * KeyRecorder — Gravador de combinações de teclas
 *
 * Componente interativo que permite ao usuário gravar uma combinação de teclas
 * (atalho) pressionando-as diretamente. Suporta modificadores (Cmd, Ctrl, Alt, Shift)
 * e teclas principais. A gravação é iniciada ao clicar no componente e encerrada
 * automaticamente quando uma combinação válida é detectada ou quando o foco é perdido.
 */
...
export const KeyRecorder: React.FC<KeyRecorderProps> = ({ currentKeys, onSave, className }) => {
    ...
    const handleKeyDown = (e: React.KeyboardEvent) => {
        ...
        // Ignora pressionamentos isolados de teclas modificadoras se possível,
        // mas precisamos exibi-las
        const modifiers = [];
        ...
        if (mainKey) {
            ...
            // Apenas modificadores pressionados — aguarda tecla principal
