/**
 * RollingTranscript — Transcrição rolante de áudio em tempo real
 *
 * Exibe o texto transcrito de áudio em tempo real em um container com
 * rolagem automática horizontal. Suporta múltiplos canais de áudio
 * (entrevistador e microfone) e indica visualmente o status de cada canal.
 * Quando um canal falha, o texto da transcrição é ocultado. Inclui um
 * indicador pulsante verde quando a transcrição está ativa e normal.
 */
