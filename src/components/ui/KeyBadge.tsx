/**
 * KeyBadge — Insígnia visual de teclas de atalho
 *
 * Renderiza uma sequência de teclas como badges visuais estilizados,
 * diferenciando visualmente teclas modificadoras (Cmd, Ctrl, Alt, Shift)
 * das teclas principais. Suporta dois tamanhos (sm/md) e adapta os
 * estilos automaticamente entre Mac e Windows.
 */
