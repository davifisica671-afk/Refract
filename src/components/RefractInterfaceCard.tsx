...
import refractLogo from "../assets/logo.webp";
import { getModifierSymbol } from "../utils/platformUtils";

/**
 * RefractInterfaceCard.tsx
 * Card promocional/marketings do Refract. Exibe uma versão estática e
 * estilizada da interface com hotkeys, campo de entrada e resposta de exemplo.
 * Usado na landing page e materiais de divulgação.
 */
...
interface Props {
  ...
  isStatic?: boolean;
  hidePill?: boolean;
  /** Ocultar o balão de consulta e a resposta da IA, mostrando apenas hotkeys + entrada */
  hideMessages?: boolean;
  /** Aplica efeito translúcido etéreo */
  dreamyVariant?: boolean;
  /** Espalhar hotkeys por toda a largura */
  spreadHotkeys?: boolean;
}

const RefractInterfaceCard = ({ className = "", isMobile = false, isStatic = false, hidePill = false, hideMessages = false, dreamyVariant = false, spreadHotkeys = false }: Props) => {
        ...
        {!hidePill && (
          ...
          >
            ...
            <div className="w-8 h-8 rounded-full flex items-center justify-center relative overflow-hidden" style={DARK_GLASS}>
              {GLOSS}
              <img src={refractLogo} alt="Refract" className="w-[28px] h-[28px] object-contain relative" draggable={false} />
            </div>
            ...
            <div className="relative">
              ...
              >
                {dreamyVariant ? (
                  ...
                  "Ask anything — Refract knows your resume and this company..."
                )}
              </div>
            </div>
...
export default RefractInterfaceCard;
